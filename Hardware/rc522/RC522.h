 ...
 * @author Ted Wang
 * @date 2025-09-01
 * @brief MFRC522 RFID driver header for STM32 (registers, commands, function prototypes).
 *
 * This header defines register addresses, commands, macros, and function prototypes for the MFRC522 RFID reader.
 * Designed for use with STM32 HAL and ISO14443A cards.
 */
